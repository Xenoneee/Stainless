...
public class Shader extends StainlessModule {
    ...
    // General
    private final Setting<ShaderMode> shader = sgGeneral.add(new EnumSetting.Builder<ShaderMode>()
        .name("shader")
    ...
    private final Setting<Double> gradientSpeed = sgGeneral.add(new DoubleSetting.Builder()
        ...
        .visible(() -> shader.get() == ShaderMode.Gradient)
        .build()
    );
    ...
    private final Setting<SettingColor> fillSecond = sgColors.add(new ColorSetting.Builder()
        ...
        .visible(() -> shader.get() == ShaderMode.Gradient || shader.get() == ShaderMode.Fade)
        .build()
    );
    ...
    private void renderEntity(Render3DEvent event, Entity entity,
        ...
        try {
            ...
            // Note: prevYaw doesn't exist in modern versions, use getYaw() directly
