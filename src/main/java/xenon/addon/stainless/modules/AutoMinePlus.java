...
public class AutoMinePlus extends StainlessModule {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (handleEatingPause()) return;

        if (tryClearUpperBedrock()) return;
        ...
        boolean handledStandingBedrock = tryPreferStandingBedrock();
    ...
    private void handleChatCooldown() {
        if (chatCooldown > 0) {
            chatCooldown--;
    ...
    private boolean tryClearUpperBedrock() {
    ...
    private boolean tryPreferStandingBedrock() {
        ...
        return handledStandingBedrock;
    }

    private void handleSupportPlacement() {
        if (support.get()
