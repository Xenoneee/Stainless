...
public class AutoConcrete extends StainlessModule {
    ...
    // === Pause While Eating (copied pattern from AutoMinePlus) ===
    ...
    // track eating state (same pattern you used)
    ...
    private void onTick(TickEvent.Pre event) {
        // cooldown always decrements regardless of pause, same as before
        if (cooldown > 0) {
            cooldown--;
            return;
        }
