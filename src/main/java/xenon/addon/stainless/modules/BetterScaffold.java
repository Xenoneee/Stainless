...
public class BetterScaffold extends StainlessModule {
    ...
    // -------------------- Placement --------------------
    private final Setting<Boolean> keepY = sgPlacement.add(new BoolSetting.Builder()
        .name("Keep Y")
        .description("Only places at the Y level you are at when enabling the module.")
        .defaultValue(false)
        .build()
    );
    private final Setting<Double> keepYreach = sgPlacement.add(new DoubleSetting.Builder()
        .name("Keep Y Reach")
    ...
    private final Setting<Boolean> onSurface = sgPlacement.add(new BoolSetting.Builder()
        .name("on-surface")
    ...
    private final Setting<Integer> horizontalRadius = sgPlacement.add(new IntSetting.Builder()
    ...
    private final Setting<Integer> verticalRadius = sgPlacement.add(new IntSetting.Builder()
    ...
    private final Setting<Integer> aboveHeadDistance = sgPlacement.add(new IntSetting.Builder()
